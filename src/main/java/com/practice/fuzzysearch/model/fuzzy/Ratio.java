...
public class Ratio {
    ...
    public static double getRatio(String s1, String s2, int xcost) {

        int len1 = s1.length();
        int len2 = s2.length();
        int lensum = len1 + len2;

        int editDistance = Ratio.levEditDistance(s1, s2, xcost);
    ...
    public static int levEditDistance(String s1, String s2, int xcost) {
        ...
        while (len1 > 0 && len2 > 0 && c1[str1] == c2[str2]){
            ...
            str1++;
            str2++;
            if(len1 > 0 && len2 > 0 && c1[str1-1] == c2[str2-1] && c1[str1] == '.'){
                len1--;
                len2--;
                try {
                    if (c1[str1 + 1] == ' ') {
    ...
    public static int apply(String s1, String s2) {
        ...
        return (int) Math.round(100 * Ratio.getRatio(s1, s2, 1));
